 ...
 */
describe('String-LE localization', function () {
	this.timeout(30_000);

	const extension = vscode.extensions.getExtension('nolindnaidoo.string-le');
	...
	it('substitutes positional placeholders at runtime', () => {
		...
		const one = vscode.l10n.t('CSV streaming failed: {0}', 7);
